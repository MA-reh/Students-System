...
for ($i = 0; $i <= $numberOfPages + 1; $i++) {
    ...
    if ($i == 0) {
        ...
        $liHTML .= " <li class='page-item'><span data-pagination='prev' onclick='paginationClick(`prev`)' class='btn me-2 pages-links prev {$isDisabled}' {$isDisabled}>Previous</span></li> <br>";
        ...
        $liHTML .= "<li class='page-item'><span data-pagination='next' onclick='paginationClick(`next`)' class='btn pages-links next {$isDisabled}' {$isDisabled}>Next</span></li> <br>";
    } else {
